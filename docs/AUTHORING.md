...
tabellen/      deliveries — the content of a Gegevensbron, and its manifest
```
...
```
Gegevensbronnen
	de tarieftabel  uit "tabellen/tarieftabel.json"
```
...
`tabellen/tarieftabel.json`. A miniature in a testgeval replaces the testset's
